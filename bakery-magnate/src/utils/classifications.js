...
export function isBehindWindow(obj) {
  return (
    obj.position.z >= -2 &&
    obj.position.z <= 16 &&
    obj.position.y >= 0 &&
...
export function isInShopTruck(obj) {
  return (
...
export function isInOwnTruck(obj) {
  return (
...
export function isInWarehouse(obj) {
  return (
...
export function isInWarehouseCabinets(obj) {
  return (
